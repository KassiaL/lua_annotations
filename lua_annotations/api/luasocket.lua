...
---@param mode string|nil optional timeout mode to set:
...
---@return fun(fun()) an equivalent function that instead of throwing exceptions, returns nil followed by an error message.
