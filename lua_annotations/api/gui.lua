...
---@param complete_function fun(self, node)|nil function to call when the      animation has completed
...
---@param options table|nil optional options table (only applicable for material constants) - index number index into array property (1 based)
...
---@param node node node to get the rotation from
---@return quaternion node rotation
...
---@return number|nil id of the custom type
...
---@param options table|nil optional options table (only applicable for material constants) - index number index into array property (1 based) - key hash name of internal property
...
---@param mode constant safe area mode
