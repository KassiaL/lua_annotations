...
---@param default_value boolean|nil (optional) default value to return if the value does not exist
---@return boolean config value as a boolean. default_value if the config key does not exist. false if no default value was supplied.
...
---@param options table|nil optional options table - ignore_secure boolean this flag ignores values might be secured by OS e.g. device_ident
