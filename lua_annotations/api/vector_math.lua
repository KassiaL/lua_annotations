...
---@return number|vector3|vector4 Clamped value or vector
...
---@return quaternion quaternion describing an equivalent rotation (231 (YZX) rotation sequence)
...
---@return vector3|vector4|quaternion new normalized vector
...
---@return number euler angle x in degrees
---@return number euler angle y in degrees
---@return number euler angle z in degrees
