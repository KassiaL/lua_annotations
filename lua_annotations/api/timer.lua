...
---@param handle number the timer handle returned by timer.delay()
...
---@return number identifier for the create timer, returns timer.INVALID_TIMER_HANDLE if the timer can not be created
