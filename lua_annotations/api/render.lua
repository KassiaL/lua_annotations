...
---@param buffer_type graphics.BUFFER_TYPE_COLOR0_BIT|graphics.BUFFER_TYPE_COLOR1_BIT|graphics.BUFFER_TYPE_COLOR2_BIT|graphics.BUFFER_TYPE_COLOR3_BIT|graphics.BUFFER_TYPE_DEPTH_BIT|graphics.BUFFER_TYPE_STENCIL_BIT which type of buffer to retrieve the height from
...
---@param buffer_type graphics.BUFFER_TYPE_COLOR0_BIT|graphics.BUFFER_TYPE_COLOR1_BIT|graphics.BUFFER_TYPE_COLOR2_BIT|graphics.BUFFER_TYPE_COLOR3_BIT|graphics.BUFFER_TYPE_DEPTH_BIT|graphics.BUFFER_TYPE_STENCIL_BIT which type of buffer to retrieve the width from
...
---@param source_factor number source factor
---@param destination_factor number destination factor
...
---@param callback fun(self, event_type)|nil A callback that receives all render related events. Pass nil if want to remove listener.
...
---@param sfail number action to take when the stencil test fails
---@param dpfail number the stencil action when the stencil test passes
---@param dppass number the stencil action when both the stencil test and the depth test pass, or when the stencil test passes and either there is no depth buffer or depth testing is not enabled
