...
---@return number gain in [0 1] range ([-60dB.. 0dB])
...
---@param gain number|nil sound gain between 0 and 1 [-60dB .. 0dB]. The final gain of the sound will be a combination of this gain, the group gain and the master gain.
...
---@param stop_properties table|nil
